...
public class RecursiveDepthFirstSearch {
    ...
    public RecursiveDepthFirstSearch(Vertex source, Vertex target, Graph graph) {
        this.source = source;
        this.target = target;
        this.graph = graph;
    }
    ...
    private void dfs(Vertex current, Vertex destination, Graph graph) {
